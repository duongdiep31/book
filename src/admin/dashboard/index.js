                ...
                <>
                    <div className="col-lg-3 col-6">
                        <div className="small-box bg-info">
                            ...
                            <Link to="/admin/orderadmin" className="small-box-footer">                {t('admin.more')}
                    ...
                    <div className="col-lg-3 col-6">
                        <div className="small-box bg-success">
                            ...
                            <Link to="/admin/prdadmin" className="small-box-footer"> {t('admin.more')}<i className="fas fa-arrow-circle-right" /></Link>
                        </div>
                    </div>
                    <div className="col-lg-3 col-6">
                        <div className="small-box bg-warning">
                            ...
                            <Link to="/admin/user" className="small-box-footer"> {t('admin.more')}<i className="fas fa-arrow-circle-right" /></Link>
                        </div>
                    </div>
                ...
                <>
                    <div className="col-lg-3 col-6">
                        <div className="small-box bg-info">
                            ...
                            <Link to="/admin/orderadmin" className="small-box-footer">{t('admin.more')} <i className="fas fa-arrow-circle-right" /></Link>
                        </div>
                    </div>
                </>
            )
                ...
                <div className="container-fluid">
                    <div className="row mb-2">
                        <div className="col-sm-6">
                            <h1 className="m-0">{t('admin.dash')}</h1>
                        </div>
                        <div className="col-sm-6">
